# This code is a python code to perform linear search on a 2D matrix to find a target value.
...
""" Perform linear search on a 2D matrix to find the target value.
    Parameters:
